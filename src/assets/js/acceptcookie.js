(function (window, undefined) {
  ...
  AcceptCookie.prototype = {
    ...
    addCookieBar: function () {
      ...
      htmlBar +=
        "<p>Мы используем файлы cookie, чтобы обеспечить вам лучший опыт работы на нашем веб-сайте. <br /> Закрывая это сообщение, вы соглашаетесь на наши файлы cookie на этом устройстве в соответствии с нашей политикой cookie, если вы не отключили их</p>";
